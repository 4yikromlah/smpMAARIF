-- ======================================================
-- DATABASE: cbt_system (Supabase / PostgreSQL)
-- Sistem CBT (Computer Based Test) Sekolah
-- Versi: 2.0 (Full dengan realtime support)
-- ======================================================

-- Hapus dan buat ulang schema (opsional, hati‑hati di production)
...
-- ======================================================
-- 9. SOAL (mendukung 5 jenis dengan JSON)
-- ======================================================
CREATE TABLE soal (
    id SERIAL PRIMARY KEY,
    id_ujian INTEGER NOT NULL REFERENCES ujian(id) ON DELETE CASCADE,
...
-- ======================================================
-- 12. SESI UJIAN SISWA (untuk monitoring)
-- ======================================================
...
CREATE INDEX idx_sesi_siswa_ujian ON sesi_ujian_siswa(id_siswa, id_ujian, status);

-- ======================================================
-- DATA AWAL (DUMMY) – Password menggunakan hash bcrypt dari 'admin123'
-- Hash: $2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi
-- Untuk PostgreSQL, gunakan bcrypt via pgcrypto atau simpan plain (untuk demo). 
-- Supabase mendukung bcrypt, tapi kita simpan string hash langsung.
-- ======================================================
...
-- SISWA (id_kelas merujuk ke id kelas yang sudah ada)
...
-- ======================================================
-- AKTIFKAN REALTIME (untuk tabel yang dimonitoring)
-- Catatan: Perintah ini harus dijalankan di Supabase Dashboard atau via SQL API
-- ======================================================
-- Untuk mengaktifkan realtime, di Supabase jalankan:
-- ALTER TABLE sesi_ujian_siswa REPLICA IDENTITY FULL;
-- ALTER TABLE ujian REPLICA IDENTITY FULL;
-- Kemudian aktifkan melalui dashboard: Database → Replication → Pilih tabel.